...
export default function CustomerDebtModal({ isOpen, onClose }: CustomerDebtModalProps) {
  ...
  return (
    <>
                  ...
                  <div key={customer.id} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between group">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <button
                        ...
                        className="w-10 h-10 rounded-full bg-rose-50 text-rose-500 flex items-center justify-center hover:bg-rose-500 hover:text-white transition-all shadow-sm"
                        title="Trả nợ"
                      >
      ...
      {/* Transaction Modal for Repayment */}
      <TransactionModal 
        ...
        initialCustomer={selectedDebtor}
      />
    </>
  );
}
