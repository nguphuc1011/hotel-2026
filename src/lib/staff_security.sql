...
VALUES 
    ...
    ('folio_edit_booking', 'Sửa thông tin Booking (Tên, Giờ, Giá)', true, 'folio'),
    ('folio_deposit', 'Nạp tiền vào tài khoản phòng', true, 'folio'),
    ('folio_group_rooms', 'Gộp nhiều phòng vào nhóm', true, 'folio'),
    ('folio_ungroup_room', 'Tách phòng khỏi nhóm', true, 'folio'),
    ('folio_transfer_master', 'Chuyển quyền chủ nhóm cho phòng khác', true, 'folio'),
