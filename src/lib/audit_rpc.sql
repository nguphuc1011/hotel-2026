-- AUDIT RPC UPDATE
-- Created: 2026-01-22
-- Description: Consolidated modern RPC definitions (staff verification + cash_flow + consolidated logic)
...
BEGIN
    ...
    -- Log Transaction (Using new audit columns)
...
BEGIN
    ...
    -- 4. Record Cash Flow for Deposit (if any)
    IF p_deposit > 0 THEN
        INSERT INTO public.cash_flow (
            flow_type, category, amount, description, created_by, verified_by_staff_id, 
