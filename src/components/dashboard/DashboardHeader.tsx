...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({ 
  ...
  return (
    <div className={cn(
      ...
      "md:relative sticky top-0 bg-white/90 backdrop-blur-md md:bg-transparent px-4 py-2 md:p-0 border-b border-slate-100 md:border-none shadow-sm md:shadow-none"
    )}>
