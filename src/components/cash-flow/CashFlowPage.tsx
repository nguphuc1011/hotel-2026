...
import { Plus, Calendar as CalendarIcon, ArrowUp, ArrowDown, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 space-y-6 pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Quản Lý Thu Chi</h1>
          <p className="text-slate-500 mt-1">Theo dõi dòng tiền và sức khỏe tài chính hệ thống</p>
        </div>
        <button
            ...
            transactions.map((tx) => {
              ...
              return (
                <div 
                  ...
                  className="bg-white rounded-xl border border-gray-100 shadow-sm hover:border-blue-200 transition-all group cursor-pointer overflow-hidden flex items-center h-[72px]"
                >
