-- MIGRATION: CHUYỂN ĐỔI SANG MULTI-TENANT (SAAS) TRIỆT ĐỂ - PHIÊN BẢN V3 (DISABLE TRIGGERS)
...
BEGIN 
    ...
    -- Tạm thời vô hiệu hóa tất cả trigger để cập nhật dữ liệu lịch sử
    FOR t_name IN 
        SELECT table_name FROM information_schema.tables 
        WHERE table_schema = 'public' AND table_type = 'BASE TABLE'
    LOOP 
        EXECUTE format('ALTER TABLE public.%I DISABLE TRIGGER ALL', t_name);
    END LOOP;
    ...
    FOR t_name IN 
        ...
        WHERE table_schema = 'public' AND table_type = 'BASE TABLE'
    LOOP 
        EXECUTE format('ALTER TABLE public.%I ENABLE TRIGGER ALL', t_name);
    END LOOP;
END $$;
