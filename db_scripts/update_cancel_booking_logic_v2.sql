-- UPDATE FUNCTION: cancel_booking
-- REASON: Change post-cancellation room status from 'available' to 'dirty' as per user request.
-- AUTHOR: Trae AI
-- DATE: 2026-01-31
...
BEGIN
    ...
    IF v_room_id IS NOT NULL THEN
        UPDATE public.rooms
        SET 
            status = 'dirty',  -- CHANGED FROM 'available' TO 'dirty'
