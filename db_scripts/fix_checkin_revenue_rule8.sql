-- Cập nhật hàm check_in_customer để tuân thủ Rule 8: Kế toán thực thu
-- Check-in chỉ ghi nhận nợ (Receivable), KHÔNG ghi nhận Doanh thu (Revenue).
    ...
    BEGIN
        ...
        IF v_initial_amount > 0 THEN
            INSERT INTO public.cash_flow (
                ...
                amount, 
                description, 
                payment_method_code, -- 'credit' chỉ tăng RECEIVABLE
                created_by, 
                verified_by_staff_id,
                verified_by_staff_name,
                ref_id, 
            ...
            -- CHỈ tăng RECEIVABLE, KHÔNG tăng REVENUE (Tuân thủ Rule 8)
