...
## Table: bookings 
- Cột: id, room_id, customer_id, check_in_at, check_out_at, rental_type, initial_price, deposit_amount, services_used, status, final_amount, system_created_at, payment_method, surcharge, total_amount. 
